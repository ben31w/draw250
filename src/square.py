...
class Square(Shape):
    ...
    def draw(self, canvas):
        ...
        self.tk_id = canvas.create_rectangle(x0, y0, x1, y1, fill=self.fill_color, outline=self.edge_color,
    ...
    def update(self, canvas, dx, dy, dash_style=(5, 5)):
        ...
        self.tk_id = canvas.create_rectangle(x0, y0, x1, y1, fill='', outline=self.edge_color, dash=self.dash_style)
